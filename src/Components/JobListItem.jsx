...
export const JobListItem = ({ obj }) => {
  return (
    <div className='item w-[1400px] h-[164px] bg-white flex flex-row justify-between items-center rounded-lg mb-2 px-4 py-6 shadow-[2px 1px 7px rgba(0, 0, 0, 0.08), 0px 2px 1px -1px rgba(0, 0, 0, 0.04), 0px 1px 3px rgba(0, 0, 0, 0.12)]'>
